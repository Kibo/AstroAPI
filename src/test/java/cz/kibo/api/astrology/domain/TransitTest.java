...
public class TransitTest {
	...
	public void planetToPointTopocentricTest() {
		...
		int iflag = SweConst.SEFLG_TOPOCTR;
	...
	public void planetToPointTopocentricSirerealTest() {
		...
		int iflag = SweConst.SEFLG_TOPOCTR | SweConst.SEFLG_SIDEREAL | SweConst.SE_SIDM_BABYL_KUGLER1;		
		...
		iflag = SweConst.SEFLG_TOPOCTR | SweConst.SEFLG_SIDEREAL | SweConst.SE_SIDM_RAMAN;
